...
- The language strip scrolls without limit. The design suggests 5 fixed + "see all" from the sixth language onward; with three it fits, and the cut was not implemented. Anyone enrolled in eight will do a lot of dragging.
