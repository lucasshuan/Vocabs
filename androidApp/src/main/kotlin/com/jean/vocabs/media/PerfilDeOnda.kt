 ...
 */
private fun picosDe(fluxo: DataInputStream, bytesDeDados: Int, bits: Int, canais: Int): FloatArray {
...
private fun marca(bytes: ByteArray, posicao: Int) = String(bytes, posicao, 4, Charsets.US_ASCII)

private fun inteiroLe(bytes: ByteArray, posicao: Int): Int =
...
private fun curtoLe(bytes: ByteArray, posicao: Int): Int =
